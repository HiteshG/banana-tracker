...
Ported from McByte without modifications.
Uses XYWH state space (center x, center y, width, height).
"""
...
class KalmanFilter:
    ...
    def update(self, mean, covariance, measurement, det_conf=.0):
        ...
        """
        projected_mean, projected_cov = self.project(mean, covariance, det_conf)
